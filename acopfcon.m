...
%     bij = B(fromBusIndex,toBusIndex);
    ...
    for i = 1:numOfBranches
        ...
        c = [c; -mpc.branch(i,13) + mpc.baseMVA * [e(fromBusIndex); e(toBusIndex); f(fromBusIndex); f(toBusIndex)]' * temp_mat * [e(fromBusIndex); e(toBusIndex); f(fromBusIndex); f(toBusIndex)]];
        c = [c;  mpc.branch(i,12) - mpc.baseMVA * [e(toBusIndex); e(fromBusIndex); f(toBusIndex); f(fromBusIndex)]' * temp_mat * [e(toBusIndex); e(fromBusIndex); f(toBusIndex); f(fromBusIndex)]];
    end
